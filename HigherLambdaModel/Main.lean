...
- Reflexive, equality-generated, symmetric, vertically composable, whiskered, interchange, `interchange'`, triangle, and pentagon 3-cells over those semantic `HoTFT2` boundaries now land in an actual simplicial `HoTFT3` layer, and the full primitive `Homotopy3Deriv` / `Homotopy3` syntax now exports generically through the `StructuralHomotopy3` bridge
- The bare generic `KanComplex` analysis now isolates the reduced front/back pentagon seed contraction, while the original `ExtensionalKanComplex` interface still suffices for the full primitive `Homotopy3Deriv` / `Homotopy3` pentagon semantics; the stronger semantic associator pentagon is isolated in `CoherentExtensionalKanComplex`, and the strict model lane derives that coherent extension axiom-free because strict fillers collapse parallel semantic 2-cells (`StrictExtensionalKanComplex.toCoherentExtensionalKanComplex`, `StrictExtensionalKanComplex.theory2_eq`, `homotopy3Deriv_in_strict_Theory3`, `homotopy3_in_strict_Theory3`, `Homotopy3Deriv_subset_strict_Theory3`, `Homotopy3_subset_strict_Theory3`)
