...
3. Higher βη-conversions using computational paths
...
like identity types in homotopy type theory. We use the ComputationalPathsLean
library to provide this higher structure.
-/
